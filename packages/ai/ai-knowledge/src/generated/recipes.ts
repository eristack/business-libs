...
export const recipes = [
  ...
  },
  {
    ...
    "rationale": "Use @eristack/payment-instrument for token-safe display + gateway refs in Postgres. Never store PAN/CVV. Load payment-instrument-core; pair with payment-manager when wiring Stripe/Xendit (planned).",
    "packages": [
      {

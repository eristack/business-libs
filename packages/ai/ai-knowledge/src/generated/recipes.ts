...
export const recipes = [
  ...
  },
  {
    ...
    "rationale": "Prefer the Eristack triad first: jwt-auth for sessions, money for amounts, doc-number for sequential documents. Load core skills before adapters.",
    "packages": [
      {
        "name": "@eristack/jwt-auth",
        "skills": [

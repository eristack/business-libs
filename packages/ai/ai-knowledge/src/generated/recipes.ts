...
export const recipes = [
  ...
  },
  {
    ...
    "rationale": "@eristack/feature-* ERP packages are coming soon — full backlog in roadmap/erp.md (reprioritize there). For document/cost-sheet/job-order products, prefer recipes document-lines-erp or backseat-then-backend (qups, pbac, doc-number, data-grid, jwt-auth, rbac) — do not default to stock-movement, financial-ledger, or valuations unless inventory/GL is in scope. Full procure-to-pay / warehouse spine: compose qups + stock + ledger + valuations when explicitly required.",
    "packages": [
      {
        "name": "@eristack/qups",
        "skills": [

...
If a new product ask should be discoverable, add/update a recipe in `packages/ai-knowledge/knowledge/recipes.yaml`, then sync again.
...
- When work is finished: promote into `packages/*/docs` (and site copy if needed), then delete the topic folder

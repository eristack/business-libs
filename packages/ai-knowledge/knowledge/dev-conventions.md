...
| `packages/jwt-auth` | `@eristack/jwt-auth` |
| `packages/doc-number` | `@eristack/doc-number` |
| `packages/ai-knowledge` | `@eristack/ai-knowledge` (this pack) |
| `examples/*` | Private runnable demos (not published) |
| `apps/web` | Public site; renders `packages/*/docs` |

...
sources:
  - 'eristack/business-libs:packages/ai-knowledge/knowledge/agent-workflow.md'
  - 'eristack/business-libs:packages/ai-knowledge/docs/sync.md'
---
...
Add/update `packages/ai-knowledge/knowledge/recipes.yaml` when users should discover the capability by product language. CI enforces `pnpm knowledge:check`.

## Docs while implementing

- WIP → `_ai-docs/<topic>/`
- Finished → promote to `packages/*/docs`, delete the topic folder

...
- 66b0029: Add `formatFixed` / `toDisplayString` (scale padding without `Number()` on amounts) and FX helpers `pickRate`, `invertFactor`, `convertAt`, `convertAtViaPivot`, `MissingFxRateError`.

...
export type TechStackItem = {
  ...
  href: string;
  note?: string;
  /** simple-icons or placeholder key — see brand-logos.ts */
  logo?: BrandLogoKey;
};
...
export const technologyStack: TechStackGroup[] = [
  ...
  },
  {
    ...
    items: [
      { name: "Google", href: "https://developers.google.com/identity/protocols/oauth2", note: "createGoogleOAuthDriver", logo: "google" },
      { name: "Microsoft Entra ID", href: "https://learn.microsoft.com/en-us/entra/identity-platform/", note: "createMicrosoftOAuthDriver", logo: "microsoft" },
      { name: "GitHub", href: "https://docs.github.com/en/apps/oauth-apps", note: "createGitHubOAuthDriver", logo: "github" },
      { name: "Sign in with Apple", href: "https://developer.apple.com/sign-in-with-apple/", note: "POST callback + JWT client secret", logo: "apple" },
      { name: "Okta / Auth0 / Keycloak", href: "https://openid.net/connect/", note: "createOktaOAuthDriver, createAuth0OAuthDriver, createKeycloakOAuthDriver", logo: "keycloak" },
      { name: "IdP driver catalog", href: "/docs/oauth/drivers", note: "LinkedIn, Slack, Discord, Cognito, Salesforce, …", logo: "openid" },
      { name: "jwt-auth handoff", href: "/docs/oauth/jwt-auth-handoff", note: "issueTokens after OAuth callback", logo: "eristack" },
    ],
  },
  {
    ...
    items: [
      { name: "SendGrid", href: "https://docs.sendgrid.com/", note: "createSendGridEmailDriver", logo: "sendgrid" },
  ...
  },
  {
    ...
    items: [
      { name: "ISO 3166", href: "https://www.iso.org/iso-3166-country-codes.html", note: "Assigned alpha-2/alpha-3", logo: "iso-3166" },
      { name: "UN/LOCODE", href: "https://unece.org/trade/cefact/unlocode-code-list-country-and-destination", note: "Five-char port codes", logo: "unlocode" },
      { name: "Country validation", href: "/docs/iso-3166/getting-started", note: "normalizeAlpha2, subdivisions", logo: "eristack" },
      { name: "Port codes", href: "/docs/unlocode/getting-started", note: "normalizeUnlocode + data-grid masters", logo: "eristack" },
    ],
  },
  {
    label: "Payments & PSPs",

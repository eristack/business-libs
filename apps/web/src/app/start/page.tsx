...
pnpm add -D typescript`,
  ...
  },
  {
    ...
    body: "Pick libraries for the job — money for amounts, jwt-auth for login, doc-number for sequences, data-grid for lists. You do not need every layer on day one.",
    code: `pnpm add @eristack/money @eristack/jwt-auth
pnpm add @eristack/doc-number @eristack/data-grid`,
    filename: "install.sh",
    language: "bash",
  },
  {

...
export const composePackageMoment: Record<ComposePackageSlug, string> = {
  ...
  uom: "Line qty in kg/pcs/box — convert without float drift",
  percent: "Tax and discount rates as ratio strings — not 0.11 literals",
  "fiscal-calendar": "Which posting period is open for this wall date",
  address: "Normalize ship-to / bill-to before partner insert",
  ...
  "doc-transitions": "draft → submit → post status graph on PBAC",
  ...
  opinion: "PATCH /invoices/:id/post — canonical document HTTP map",
  ...
  "ai-dev": "pnpm eristack plan --json before touching twenty scripts",
